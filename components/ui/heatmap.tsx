...
function interpolateRgb(value: number, max: number, minColor: string, maxColor: string, scale: InterpolationModes) {
...
function ValueIndicator({ cellSize, displayStyle, value, maxValue, color, style, ...htmlProps }: ValueIndicatorProps) {
              ...
              <Tooltip key={dayIdx}>
                ...
                <TooltipContent>
                  <div className="text-xs">
                    <div>
                      {dateDisplayFunction ? dateDisplayFunction(dateForDisplay) : dateForDisplay.toDateString()}
                    </div>
