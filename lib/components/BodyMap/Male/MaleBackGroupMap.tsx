...
const SVGComponent = (props) => (
  ...
  >
      ...
      <radialGradient id="jointradial" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">
        <stop
          ...
          style={{
            ...
            stopOpacity: 1,
            "--darkreader-inline-stopcolor": "var(--darkreader-text-fe5b7f, #f26a80)",
          }}
        ...
        <stop
          ...
          style={{
            ...
            stopOpacity: 1,
            "--darkreader-inline-stopcolor": "var(--darkreader-text-e7ecef, #eae1d2)",
          }}
          data-darkreader-inline-stopcolor=""
        />
      </radialGradient>
    ...
    <g id="traps-middle" className="bodymap text-mw-red" data-force-highlight="true">
      <path
    ...
    <g id="body" className="body-map__model">
      ...
      <line
        ...
        strokeWidth={3.52}
        style={{
          "--darkreader-inline-stroke": "var(--darkreader-border-484a68, #756b5c)",
        }}
        data-darkreader-inline-stroke=""
      />
      <path
